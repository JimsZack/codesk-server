...
lazy_static::lazy_static! {
    ...
    pub static ref APP_NAME: RwLock<String> = RwLock::new("CoDesk".to_owned());
...
pub const RENDEZVOUS_PORT: i32 = 58888;
pub const RELAY_PORT: i32 = 58889;
pub const WS_RENDEZVOUS_PORT: i32 = 58890;
pub const WS_RELAY_PORT: i32 = 58891;
